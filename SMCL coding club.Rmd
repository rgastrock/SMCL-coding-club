...
Using all the math above, we managed to calculate learning curves: the reach deviations relative to the target (in degrees angle) for every participant in the first 90 trials.
...
Bootstrapped exponential curves, fit to the learning curves in each group:
